<?php
    ...
    if(!isset($_POST["botonAsignar"])) {
        ...
        echo '<form action="#" method="POST">
               ...
               <label for="lugar">Maquinas</label><br/><br/>';
        ...
        echo '  </select>
                       <br/><br/>
                       <input type="submit" name="botonAsignar" value="ASIGNAR LUGAR"><br/>
                       </form>';
    }else {
        ...
        if($objeto->comprobar()>0){
            echo '<link rel=stylesheet href=../Estilos.css>
               ...
               <br><br>
               <a href="Asignar.php">Volver editar maquina</a>';
        }else{
            echo '<link rel=stylesheet href=../Estilos.css>
               <div id="imagen"><img src="../jesuitas.png"></div>
               <br><br>
               <label id="error">Error al modificar maquina, este lugar ya tiene asignada una maquina</label>
                <br><br>
                <a href="Asignar.php">Volver editar maquina</a>';
        }
    }
