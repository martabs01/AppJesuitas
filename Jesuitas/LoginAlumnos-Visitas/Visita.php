<?php
    if(isset($_SESSION["ip"])){
        ...
        $objeto=new consulta();
        session_start();//Comienzo inicio sesion
        //Formulario Inicial
        if(!isset($_POST["visitar"])){
            //Mostrar array Cookie
            if(isset($_COOKIE)){
           ...
           <form action="#" method="POST">
            ...
            echo '</select>
                       <br/><br/><input type="submit" name="visitar" value="REALIZAR VISITA">
                       <br><br>
                       <a href="../CerrarSesionAl.php">Cerrar Sesion</a>
           </form>';
        }else {
            ...
            if($objeto->comprobar()>0){
                ...
                <div id="imagen"><img src="../jesuitas.png"></div>
                <br>
                Visita realizada correctamente
                <br>
                ...
                <label id="error">ERROR , VISITA NO REALIZADA CORRECTAMENTE.
                    <br>
                    El lugar ya ha sido visitado anteriormente
                </label>
                <br><br>
        ...
        echo' 
                ...
                <br><br>
                <a href="../LoginAlumnos-Visitas/Inicio.php">Inicar Sesion</a>';
    }
?>